...
export default function HeaderCourse() {
  ...
  return (
    <div className="w-full mx-auto md:my-10 mt-24 md:mt-20 md:text-[22px] text-[14px] px-2 md:px-0 gap-14 font-medium capitalize flex flex-col  max-w-7xl">
      ...
      <h3 className="md:text-3xl text-xl text-center text-[#d63583] font-bold mb-0">Kursus Makeup</h3>
      <h5 className="md:text-2xl text-l text-center text-[#feacc4]">untuk pemula hingga profesional</h5>
      </div>
